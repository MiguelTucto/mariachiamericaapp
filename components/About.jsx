    ...
    return (
        <>
            <div className={'md:px-80 md:py-[100px] px-10 py-5 flex flex-col'} ref={text}>
                <motion.h2 initial="offscreen" whileInView="onscreen" viewport={{ once: true, amount: 0.1}} variants={cardVariants} className={'font-bold md:text-8xl text-5xl '}>¿Quienes Somos?</motion.h2>
                <motion.p initial="offscreen" whileInView="onscreen" viewport={{ once: true, amount: 0.1}} variants={cardVariants} className={'md:mt-10 mt-5 text-lg leading-tight font-sans text-gray-900'}>
